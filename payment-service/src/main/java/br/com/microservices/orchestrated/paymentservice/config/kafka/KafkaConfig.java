...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.topic.pagamento-sucesso}")
    private String pagamentoSucessoTopic;

    @Value("${spring.kafka.topic.pagamento-falha}")
    private String pagamentoFalhaTopic;
    ...
    public NewTopic pagamentoSucessoTopic(){
        return buildTopic(pagamentoSucessoTopic);
    }

    @Bean
    public NewTopic pagamentoFalhaTopic(){
        return buildTopic(pagamentoFalhaTopic);
    }
}
