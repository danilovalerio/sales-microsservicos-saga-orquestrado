...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.topic.inicia-saga}")
    private String iniciaSagaTopic;

    @Value("${spring.kafka.topic.finaliza-saga}")
    private String finalizaSagaTopic;
    ...
    public NewTopic iniciaSagaTopic(){
        return buildTopic(iniciaSagaTopic);
    }

    @Bean
    public NewTopic finalizaSagaTopic(){
        return buildTopic(finalizaSagaTopic);
    }
}
