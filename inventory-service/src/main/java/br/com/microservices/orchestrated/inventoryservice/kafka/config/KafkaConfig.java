...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.topic.inventario-sucesso}")
    private String inventarioSucessoTopic;

    @Value("${spring.kafka.topic.inventario-falha}")
    private String inventarioFalhaTopic;
    ...
    public NewTopic inventarioSucessoTopic(){
        return buildTopic(inventarioSucessoTopic);
    }

    @Bean
    public NewTopic inventarioFalhaTopic(){
        return buildTopic(inventarioFalhaTopic);
    }
